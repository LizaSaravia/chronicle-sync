...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const settingsCustomApiGroup = document.getElementById('settings-custom-api-group');
  const settingsCustomApiUrl = document.getElementById('settings-custom-api-url');
  const settingsErrorReporting = document.getElementById('settings-error-reporting');
  ...
  function updateDashboardLink(environment, customApiUrl) {
    ...
    if (environment === 'custom' && customApiUrl) {
      ...
      dashboardUrl = environment === 'staging'
  ...
  try {
    ...
    if (storage.initialized) {
      ...
      if (storage.groupId) {
        ...
        settingsErrorReporting.checked = storage.errorReporting === undefined 
