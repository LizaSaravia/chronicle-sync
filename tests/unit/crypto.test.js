...
describe('CryptoManager', () => {
  ...
  describe('constructor', () => {
    it('should throw error for empty password', () => {
      expect(() => new CryptoManager('')).toThrow('Password must be a non-empty string');
    });

    it('should throw error for non-string password', () => {
      expect(() => new CryptoManager(123)).toThrow('Password must be a non-empty string');
    });
  ...
  describe('encrypt', () => {
    ...
    it('should handle encryption errors', async () => {
      ...
      await expect(cryptoManager.encrypt({ test: 'data' }))
  ...
  describe('decrypt', () => {
    ...
    it('should handle decryption errors', async () => {
      ...
      await expect(cryptoManager.decrypt('invalid-data'))
  ...
  describe('test', () => {
    ...
    it('should fail if encryption fails', async () => {
      ...
      await expect(cryptoManager.test())
    ...
    it('should fail if decrypted data does not match', async () => {
      ...
      await expect(cryptoManager.test())
        .rejects.toThrow('Failed to initialize encryption: Encryption test failed: data mismatch');
    });
  });
});